...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber stereo_odom_sub = nh.subscribe<nav_msgs::Odometry>(odom_sub_topic, 1, stereo_odom_cb);
    ros::Subscriber depth_image_sub = nh.subscribe<sensor_msgs::Image>(depth_image_sub_topic, 1, depth_image_cb);
